...
import { LogOut, LogIn, Calendar, Users, List, Download, Upload } from 'lucide-react';
...
export default function Layout({ user, children, activeView, onViewChange, onSaveData, onLoadData }: LayoutProps) {
